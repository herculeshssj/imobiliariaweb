...
@Repository
public class ServicoManutencaoRepository extends AbstractCRUDRepository<ServicoManutencao>{

	public ServicoManutencaoRepository() {
		super(new ServicoManutencao());
	}

	@SuppressWarnings("unchecked")
	public List<ServicoManutencao> findAll() {
		return getQuery("FROM ServicoManutencao servico").list();
	}
