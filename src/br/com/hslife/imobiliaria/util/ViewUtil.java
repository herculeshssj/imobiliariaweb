...
public class ViewUtil {
	...
	private static String[] modulos = {"aluguel","agenda","cliente","clientepj","conta","contrato","corretor","formapagamento","funcionario","grupo","imovel","indiceReajuste","lancamento","modeloContrato","relatorio","seguradora","servicomanutencao","usuario"};
