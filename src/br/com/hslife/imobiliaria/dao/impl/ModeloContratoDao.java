...
public class ModeloContratoDao extends HibernateGenericDao implements IModeloContratoDao {

	@Override
	public List<ModeloContrato> buscarTodosAtivos() {
		return queryList("modeloContrato.buscarTodosAtivos");
	}
