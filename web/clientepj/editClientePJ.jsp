		...
		<div id="content">
			...
			<rich:message for="frmClientePJ" style="color: #ff0000; font-weight: bold;"></rich:message>
					...
					<h:panelGrid columns="3" cellspacing="10" style="padding: 10px 10px 10px 10px;">
						...
						* Nome Fantasia:
						<h:inputText id="txtNomeFantasia" value="#{clientePJMB.clientePJ.nomeFantasia }" size="50" maxlength="100" required="true" requiredMessage="Informe o nome da empresa!" disabled="#{!clientePJMB.clientePJ.ativo }"/>
						<rich:message for="txtNomeFantasia" style="color: #ff0000; font-weight: bold;"></rich:message>
						
						* CNPJ:
						<h:inputText id="txtCnpj" value="#{clientePJMB.clientePJ.cnpj }" size="16" disabled="#{!clientePJMB.clientePJ.ativo }"
						...
						Ramo de atividade:
						<h:inputText id="txtRamoAtividade" value="#{clientePJMB.clientePJ.ramoAtividade }" size="70" maxlength="100" disabled="#{!clientePJMB.clientePJ.ativo }"/>
						<rich:message for="txtRamoAtividade" style="color: #ff0000; font-weight: bold;"></rich:message>
							
						Nº da pasta/arquivo:
						<h:inputText value="#{clientePJMB.clientePJ.numPasta }" maxlength="10"  disabled="#{!clientePJMB.clientePJ.ativo }"/>		
					...
					<h:panelGrid id="pnlSocios" columns="5" cellspacing="10" style="padding: 10px 10px 10px 10px;">
						...
						Sócio:
						<h:selectOneMenu id="txtSocio" value="#{clientePJMB.idSocio }" disabled="#{!clientePJMB.clientePJ.ativo }">
							<f:selectItem itemLabel="Selecione um sócio"/>							
							<f:selectItems value="#{clientePJMB.socios }"/>
						</h:selectOneMenu>
						
						Função:
						<h:inputText value="#{clientePJMB.socio.funcao }" disabled="#{!clientePJMB.clientePJ.ativo }"></h:inputText>
						
						<a4j:commandButton value="Adicionar" style="padding: 3px 10px;" action="#{clientePJMB.adicionarSocio }" reRender="tableSocios,pnlSocios" disabled="#{!clientePJMB.clientePJ.ativo }"/>
						...
						<rich:dataTable id="tableSocios" value="#{clientePJMB.listaSocio }"
							...
							<rich:column style="text-align: center">
								...
								<a4j:commandLink value="Remover" reRender="tableSocios" action="#{clientePJMB.removerSocio }" disabled="#{!clientePJMB.clientePJ.ativo }">
					...
					<h:panelGrid columns="3" cellspacing="10" style="padding: 10px 10px 10px 10px;">
						...
						* CEP:
						<h:panelGroup>
							<h:inputText id="txtCep" value="#{clientePJMB.clientePJ.endereco.cep }" required="true" requiredMessage="Informe o CEP!" size="9" maxlength="8"  disabled="#{!clientePJMB.clientePJ.ativo }">
								<f:validator validatorId="cepvalidator"/>
							</h:inputText>
							&nbsp;
						<a4j:commandButton value="Pesquisar" action="#{clientePJMB.buscarEndereco }" reRender="txtTipoLogradouro,txtLogradouro,txtBairro,txtUF,txtCidade,txtCep" style="padding: 3px 10px;" disabled="#{!clientePJMB.clientePJ.ativo }"/>
						</h:panelGroup>
						<rich:message for="txtCep" style="color: #ff0000; font-weight: bold;"></rich:message>
						
						* Tipo de logradouro:
						<h:inputText id="txtTipoLogradouro" value="#{clientePJMB.clientePJ.endereco.tipoLogradouro }" maxlength="100"  disabled="#{!clientePJMB.clientePJ.ativo }"/>
						<rich:message for="txtTipoLogradouro" style="color: #ff0000; font-weight: bold;"></rich:message>
						
						* Logradouro:
						<h:inputText id="txtLogradouro"  disabled="#{!clientePJMB.clientePJ.ativo }"
							value="#{clientePJMB.clientePJ.endereco.logradouro }" size="50"							
							maxlength="150">							
						</h:inputText>
						<rich:message for="txtLogradouro" style="color: #ff0000; font-weight: bold;"></rich:message>
						
						* Número:
						<h:inputText id="txtNumero" value="#{clientePJMB.clientePJ.endereco.numero }" disabled="#{!clientePJMB.clientePJ.ativo }"							
							maxlength="10">							
						</h:inputText>
						<rich:message for="txtNumero" style="color: #ff0000; font-weight: bold;"></rich:message>
						
						Complemento:
						<h:inputText value="#{clientePJMB.clientePJ.endereco.complemento }" disabled="#{!clientePJMB.clientePJ.ativo }" maxlength="50"></h:inputText>
						<h:inputHidden/>
						
						* Bairro:
						<h:inputText id="txtBairro" value="#{clientePJMB.clientePJ.endereco.bairro }"  disabled="#{!clientePJMB.clientePJ.ativo }"							
							maxlength="50"/>
						<rich:message for="txtBairro" style="color: #ff0000; font-weight: bold;"></rich:message>
						
						* Cidade:
						<h:inputText id="txtCidade" value="#{clientePJMB.clientePJ.endereco.cidade }"  disabled="#{!clientePJMB.clientePJ.ativo }"/>
						<rich:message for="txtCidade" style="color: #ff0000; font-weight: bold;"></rich:message>
						
						* UF:
						<h:inputText id="txtUF" value="#{clientePJMB.clientePJ.endereco.uf }" disabled="#{!clientePJMB.clientePJ.ativo }"/>
					...
					<h:panelGrid id="pnlTelefone" columns="7" cellspacing="10" style="padding: 10px 10px 10px 10px;">
						...
						DDD:	
						<h:inputText value="#{clientePJMB.telefone.ddd }" size="5" disabled="#{!clientePJMB.clientePJ.ativo }"
						...
						Telefone:
						<h:inputText value="#{clientePJMB.telefone.numero }" size="10" disabled="#{!clientePJMB.clientePJ.ativo }"
						...
						Tipo:
						<h:selectOneMenu value="#{clientePJMB.telefone.tipoTelefone }" disabled="#{!clientePJMB.clientePJ.ativo }">
						...
						<a4j:commandButton value="Adicionar" style="padding: 3px 10px;" action="#{clientePJMB.adicionarTelefone }" reRender="tableTelefones,pnlTelefone"  disabled="#{!clientePJMB.clientePJ.ativo }"/>
					</h:panelGrid>
						...
						<rich:dataTable id="tableTelefones" value="#{clientePJMB.listaTelefone }"
							...
							<rich:column style="text-align: center">
								...
								<a4j:commandLink value="Remover" reRender="tableTelefones"  disabled="#{!clientePJMB.clientePJ.ativo }"
									action="#{clientePJMB.removerTelefone }">
			...
			<h:panelGrid columns="9" cellspacing="10" style="padding: 10px 10px 10px 10px;" width="100%">
				<f:facet name="header">
					<h:outputText value="Contratos de aluguel"></h:outputText>
				</f:facet>
				<rich:dataTable width="100%" value="#{clientePJMB.clientePJ.contratos }"
					var="item">
					<rich:column style="text-align: center">
						<f:facet name="header">
			...
			<h:commandButton value="Editar" style="padding: 3px 10px;" action="#{clientePJMB.edit }" disabled="#{!clientePJMB.clientePJ.ativo }" rendered="#{clientePJMB.canEdit }"/>
			&nbsp;&nbsp;
			<h:commandButton value="Cancelar" style="padding: 3px 10px;" action="#{clientePJMB.cancelAction }" immediate="true"></h:commandButton>
