...
<div id="content">
		...
		<h3>				
					<img src="../images/icon_contrato.png" height="32" width="32"/>
					<h:commandLink value="Contratos" action="listContrato"></h:commandLink>
					&nbsp;	
					
					<img src="../images/icon_modelo.png" height="32" width="32"/>
					<h:commandLink value="Modelos de Contrato" action="formModeloContrato"></h:commandLink>
					&nbsp;							
