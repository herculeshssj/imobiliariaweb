...
<f:subview id="cabecalho">
	...
	<h3>Agendamentos de hoje</h3>
		...
		<h:form>
		<rich:messages style="color: #ff0000; font-weight: bold;"/>
			<rich:dataTable width="100%" var="item" value="#{homeMB.dadosModelo }">
				...
				<rich:column style="text-align: center">
					...
					de <h:outputText value="#{item.horaInicio }" />h às <h:outputText
						value="#{item.horaFim }" />h 
				</rich:column>
				<%--
				<rich:column style="text-align: center">
					<f:facet name="header">
					...
					<h:commandLink value="Remarcar" action="#{homeMB.remarcar }"
						rendered="#{!item.visitado }">						
					</h:commandLink>
				</rich:column>
				 --%>
			</rich:dataTable>
