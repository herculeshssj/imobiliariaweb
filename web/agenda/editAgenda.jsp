...
<f:subview id="cabecalho">
	...
	<h:form id="frmAgenda">
		<div id="content">
			...
			<h2>Agenda de visitas - Editar</h2>
				...
				<h:panelGrid columns="3" cellspacing="10"
						...
						* Imóvel:
						<h:selectOneMenu id="txtImovel" required="true" requiredMessage="Informe o imóvel!" value="#{agendaMB.idImovel }" disabled="#{agendaMB.agenda.visitado }">
						...
						* Corretor:
						<h:selectOneMenu id="txtCorretor" required="true" requiredMessage="Informe o corretor!" value="#{agendaMB.idCorretor }" disabled="#{agendaMB.agenda.visitado }">
							<f:selectItem itemLabel="Selecione"/>
						...
						* Nome do cliente:
						<h:inputText id="txtNomeCliente" value="#{agendaMB.agenda.nomeCliente }" disabled="#{agendaMB.agenda.visitado }"
							maxlength="100" size="70" required="true"
						...
						* E-Mail:
						<h:inputText id="txtEmailCliente" value="#{agendaMB.agenda.emailCliente }" disabled="#{agendaMB.agenda.visitado }"
							maxlength="100" required="true" size="50"
							requiredMessage="Informe o e-mail do cliente!"
							validatorMessage="E-Mail informado é inválido!">							
						...
						* Telefone de contato:
						<h:panelGroup>
							<h:inputText id="txtTelefoneCliente" value="#{agendaMB.agenda.telefoneCliente }" required="true" requiredMessage="Informe o telefone do cliente!" disabled="#{agendaMB.agenda.visitado }"/>
						...
						* Data da visita:
						<h:panelGroup>
						<h:inputText id="txtDataVisita" value="#{agendaMB.agenda.data }" required="true" requiredMessage="Informe a data da visita!" converterMessage="Formato de data inválido! Tente dd/mm/aaaa e somente números!" disabled="#{agendaMB.agenda.visitado }">
						...
						<h:outputText value="Observação" rendered="#{agendaMB.agenda.visitado }"></h:outputText>
						<h:inputTextarea id="txtObservação" value="#{agendaMB.agenda.observacao }" cols="40" rows="7" rendered="#{agendaMB.agenda.visitado }" disabled="true"></h:inputTextarea>			
					</h:panelGrid>
