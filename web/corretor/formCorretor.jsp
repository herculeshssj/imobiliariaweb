		...
		<div id="content">
			...
			<h2>Corretor - Cadastrar</h2>
					...
					<h:panelGrid columns="3" cellspacing="10" style="padding: 10px 10px 10px 10px;">
						...
						* Nome:
						<h:inputText id="txtNome" value="#{corretorMB.corretor.nome }" size="50" maxlength="100" required="true" requiredMessage="Informe o nome do corretor!" />
						<rich:message for="txtNome" style="color: #ff0000; font-weight: bold;"></rich:message>
						
						* CPF:
						<h:inputText id="txtCpf" value="#{corretorMB.corretor.cpf }" size="13" 
						...
						* Gênero:
						<h:selectOneRadio id="txtGenero" value="#{corretorMB.corretor.genero }" required="true" requiredMessage="Informe o gênero!" layout="lineDirection" >
						...
						Nacionalidade:
						<h:inputText id="txtNacionalidade" value="#{corretorMB.corretor.nacionalidade }" maxlength="50" />
						<h:inputHidden/>
						
						Naturalidade:
						<h:inputText id="txtNaturalidade" value="#{corretorMB.corretor.naturalidade }" maxlength="50" />
						<h:inputHidden/>
						
						Estado Civil:
						<h:selectOneMenu id="txtEstadoCivil" value="#{corretorMB.corretor.estadoCivil }" required="true" requiredMessage="Informe o estado civil!" >							
						...
						Filiação - Pai:
						<h:inputText id="txtFiliacaoPai" value="#{corretorMB.corretor.filiacaoPai }" maxlength="100" size="50" />
						<h:inputHidden/>
						
						Filiação - Mãe:
						<h:inputText id="txtFiliacaoMae" value="#{corretorMB.corretor.filiacaoMae }" maxlength="100" size="50" />
						<h:inputHidden/>
						
						E-Mail:
						<h:inputText id="txtEmail" value="#{corretorMB.corretor.email }"  
						...
						Profissão:
						<h:inputText id="txtProfissao" value="#{corretorMB.corretor.profissao }" maxlength="50" />
						<h:inputHidden/>
						
						
						RG:
						<h:inputText id="txtRg" value="#{corretorMB.corretor.rg }"	maxlength="15" />
						<h:inputHidden/>
						
						Orgão Emissor:
						<h:inputText id="txtOrgaoEmissor" value="#{corretorMB.corretor.orgaoEmissor }"	maxlength="30" />
						<h:inputHidden/>
						...
						Nº da pasta/arquivo:
						<h:inputText value="#{corretorMB.corretor.numPasta }" maxlength="10"  />		
					...
					<h:panelGrid columns="3" cellspacing="10" style="padding: 10px 10px 10px 10px;">
						...
						Nome:
						<h:inputText id="txtNomeConjuge" value="#{corretorMB.corretor.nomeConjuge }" size="50" maxlength="100" />
						<rich:message for="txtNomeConjuge" style="color: #ff0000; font-weight: bold;"></rich:message>
						
						CPF:
						<h:inputText id="txtCpfConjuge" value="#{corretorMB.corretor.cpfConjuge }" size="13" 
							maxlength="11" converterMessage="CPF só deve conter números!">												
							<f:converter converterId="cpfconverter"/>
							<f:validator validatorId="cpfvalidator"/>
						</h:inputText>
						...
						Gênero:
						<h:selectOneRadio id="txtGeneroConjuge" value="#{corretorMB.corretor.generoConjuge }" layout="lineDirection" >
							<f:selectItem itemValue="M" itemLabel="Masculino"/>
							<f:selectItem itemValue="F" itemLabel="Feminino"/>
						</h:selectOneRadio>
						...
						Nacionalidade:
						<h:inputText id="txtNacionalidadeConjuge" value="#{corretorMB.corretor.nacionalidadeConjuge }" maxlength="50" />
						<h:inputHidden/>
						
						Naturalidade:
						<h:inputText id="txtNaturalidadeConjuge" value="#{corretorMB.corretor.naturalidadeConjuge }" maxlength="50" />
						<h:inputHidden/>
						
						Filiação - Pai:
						<h:inputText id="txtFiliacaoPaiConjuge" value="#{corretorMB.corretor.filiacaoPaiConjuge }" maxlength="100" size="50" />
						<h:inputHidden/>
						
						Filiação - Mãe:
						<h:inputText id="txtFiliacaoMaeConjuge" value="#{corretorMB.corretor.filiacaoMaeConjuge }" maxlength="100" size="50" />
						<h:inputHidden/>
						
						Profissão:
						<h:inputText id="txtProfissaoConjuge" value="#{corretorMB.corretor.profissaoConjuge }" maxlength="50" />
						<h:inputHidden/>						
						
						RG:
						<h:inputText id="txtRgConjuge" value="#{corretorMB.corretor.rgConjuge }"	maxlength="15" />
						<h:inputHidden/>
						
						Orgão Emissor:
						<h:inputText id="txtOrgaoEmissorConjuge" value="#{corretorMB.corretor.orgaoEmissorConjuge }"	maxlength="30" />
						<h:inputHidden/>
					...
					<h:panelGrid columns="3" cellspacing="10" style="padding: 10px 10px 10px 10px;">
						...
						* CEP:
						<h:panelGroup>
							<h:inputText id="txtCep" value="#{corretorMB.corretor.endereco.cep }" required="true" requiredMessage="Informe o CEP!" size="9" maxlength="8"  >
								<f:validator validatorId="cepvalidator"/>
							</h:inputText>
							&nbsp;
						<a4j:commandButton value="Pesquisar" action="#{corretorMB.buscarEndereco }" reRender="txtTipoLogradouro,txtLogradouro,txtBairro,txtUF,txtCidade,txtCep" style="padding: 3px 10px;"/>
						</h:panelGroup>
						<rich:message for="txtCep" style="color: #ff0000; font-weight: bold;"></rich:message>
						
						* Tipo de logradouro:
						<h:inputText id="txtTipoLogradouro" value="#{corretorMB.corretor.endereco.tipoLogradouro }" maxlength="100"  />
						...
						* Número:
						<h:inputText id="txtNumero" value="#{corretorMB.corretor.endereco.numero }"							
							maxlength="10">							
						</h:inputText>
						<rich:message for="txtNumero" style="color: #ff0000; font-weight: bold;"></rich:message>
						
						Complemento:
						<h:inputText value="#{corretorMB.corretor.endereco.complemento }"  maxlength="50"></h:inputText>
						<h:inputHidden/>
						
						* Bairro:
						<h:inputText id="txtBairro" value="#{corretorMB.corretor.endereco.bairro }"							
							maxlength="50"/>
						<rich:message for="txtBairro" style="color: #ff0000; font-weight: bold;"></rich:message>
						
						* Cidade:
						<h:inputText id="txtCidade" value="#{corretorMB.corretor.endereco.cidade }"  />
						<rich:message for="txtCidade" style="color: #ff0000; font-weight: bold;"></rich:message>
						
						* UF:
						<h:inputText id="txtUF" value="#{corretorMB.corretor.endereco.uf }" />
					...
					<h:panelGrid id="pnlTelefone" columns="7" cellspacing="10" style="padding: 10px 10px 10px 10px;">
						...
						DDD:	
						<h:inputText value="#{corretorMB.telefone.ddd }" size="5" 
						...
						Telefone:
						<h:inputText value="#{corretorMB.telefone.numero }" size="10" 
						...
						Tipo:
						<h:selectOneMenu value="#{corretorMB.telefone.tipoTelefone }" >
						...
						<a4j:commandButton value="Adicionar" style="padding: 3px 10px;" action="#{corretorMB.adicionarTelefone }" reRender="tableTelefones,pnlTelefone"  />
					</h:panelGrid>
			...
			<h:commandButton value="Cadastrar" style="padding: 3px 10px;"
				action="#{corretorMB.add }" rendered="#{corretorMB.canAdd }"></h:commandButton>
			&nbsp;&nbsp;
			<h:commandButton value="Cancelar" style="padding: 3px 10px;"
				immediate="true" action="#{corretorMB.cancelAction }"></h:commandButton>
