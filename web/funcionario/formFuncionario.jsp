		...
		<div id="content">
			...
			<h2>Funcionario - Cadastrar</h2>
					...
					<h:panelGrid columns="3" cellspacing="10" style="padding: 10px 10px 10px 10px;">
						...
						* Nome:
						<h:inputText id="txtNome" value="#{funcionarioMB.funcionario.nome }" size="50" maxlength="100" required="true" requiredMessage="Informe o nome do funcionario!" />
						<rich:message for="txtNome" style="color: #ff0000; font-weight: bold;"></rich:message>
						
						* CPF:
						<h:inputText id="txtCpf" value="#{funcionarioMB.funcionario.cpf }" size="13" 
						...
						* Gênero:
						<h:selectOneRadio id="txtGenero" value="#{funcionarioMB.funcionario.genero }" required="true" requiredMessage="Informe o gênero!" layout="lineDirection" >
						...
						Nacionalidade:
						<h:inputText id="txtNacionalidade" value="#{funcionarioMB.funcionario.nacionalidade }" maxlength="50" />
						<h:inputHidden/>
						
						Naturalidade:
						<h:inputText id="txtNaturalidade" value="#{funcionarioMB.funcionario.naturalidade }" maxlength="50" />
						<h:inputHidden/>
						
						Estado Civil:
						<h:selectOneMenu id="txtEstadoCivil" value="#{funcionarioMB.funcionario.estadoCivil }" required="true" requiredMessage="Informe o estado civil!" >							
						...
						Filiação - Pai:
						<h:inputText id="txtFiliacaoPai" value="#{funcionarioMB.funcionario.filiacaoPai }" maxlength="100" size="50" />
						<h:inputHidden/>
						
						Filiação - Mãe:
						<h:inputText id="txtFiliacaoMae" value="#{funcionarioMB.funcionario.filiacaoMae }" maxlength="100" size="50" />
						<h:inputHidden/>
						
						E-Mail:
						<h:inputText id="txtEmail" value="#{funcionarioMB.funcionario.email }"  
						...
						Profissão:
						<h:inputText id="txtProfissao" value="#{funcionarioMB.funcionario.profissao }" maxlength="50" />
						<h:inputHidden/>
						
						
						RG:
						<h:inputText id="txtRg" value="#{funcionarioMB.funcionario.rg }"	maxlength="15" />
						<h:inputHidden/>
						
						Orgão Emissor:
						<h:inputText id="txtOrgaoEmissor" value="#{funcionarioMB.funcionario.orgaoEmissor }"	maxlength="30" />
						<h:inputHidden/>
						...
						* Cargo/Função:
						...
						Nº da pasta/arquivo:
						<h:inputText value="#{funcionarioMB.funcionario.numPasta }" maxlength="10"  />		
					...
					<h:panelGrid columns="3" cellspacing="10" style="padding: 10px 10px 10px 10px;">
						...
						Nome:
						<h:inputText id="txtNomeConjuge" value="#{funcionarioMB.funcionario.nomeConjuge }" size="50" maxlength="100" />
						<rich:message for="txtNomeConjuge" style="color: #ff0000; font-weight: bold;"></rich:message>
						
						CPF:
						<h:inputText id="txtCpfConjuge" value="#{funcionarioMB.funcionario.cpfConjuge }" size="13" 
							maxlength="11" converterMessage="CPF só deve conter números!">												
							<f:converter converterId="cpfconverter"/>
							<f:validator validatorId="cpfvalidator"/>
						</h:inputText>
						...
						Gênero:
						<h:selectOneRadio id="txtGeneroConjuge" value="#{funcionarioMB.funcionario.generoConjuge }" layout="lineDirection" >
							<f:selectItem itemValue="M" itemLabel="Masculino"/>
							<f:selectItem itemValue="F" itemLabel="Feminino"/>
						</h:selectOneRadio>
						...
						Nacionalidade:
						<h:inputText id="txtNacionalidadeConjuge" value="#{funcionarioMB.funcionario.nacionalidadeConjuge }" maxlength="50" />
						<h:inputHidden/>
						
						Naturalidade:
						<h:inputText id="txtNaturalidadeConjuge" value="#{funcionarioMB.funcionario.naturalidadeConjuge }" maxlength="50" />
						<h:inputHidden/>
						
						Filiação - Pai:
						<h:inputText id="txtFiliacaoPaiConjuge" value="#{funcionarioMB.funcionario.filiacaoPaiConjuge }" maxlength="100" size="50" />
						<h:inputHidden/>
						
						Filiação - Mãe:
						<h:inputText id="txtFiliacaoMaeConjuge" value="#{funcionarioMB.funcionario.filiacaoMaeConjuge }" maxlength="100" size="50" />
						<h:inputHidden/>
						
						Profissão:
						<h:inputText id="txtProfissaoConjuge" value="#{funcionarioMB.funcionario.profissaoConjuge }" maxlength="50" />
						<h:inputHidden/>						
						
						RG:
						<h:inputText id="txtRgConjuge" value="#{funcionarioMB.funcionario.rgConjuge }"	maxlength="15" />
						<h:inputHidden/>
						
						Orgão Emissor:
						<h:inputText id="txtOrgaoEmissorConjuge" value="#{funcionarioMB.funcionario.orgaoEmissorConjuge }"	maxlength="30" />
						<h:inputHidden/>
					...
					<h:panelGrid columns="3" cellspacing="10" style="padding: 10px 10px 10px 10px;">
						...
						* CEP:
						<h:panelGroup>
							<h:inputText id="txtCep" value="#{funcionarioMB.funcionario.endereco.cep }" required="true" requiredMessage="Informe o CEP!" size="9" maxlength="8"  >
								<f:validator validatorId="cepvalidator"/>
							</h:inputText>
							&nbsp;
						<a4j:commandButton value="Pesquisar" action="#{funcionarioMB.buscarEndereco }" reRender="txtTipoLogradouro,txtLogradouro,txtBairro,txtUF,txtCidade,txtCep" style="padding: 3px 10px;"/>
						</h:panelGroup>
						<rich:message for="txtCep" style="color: #ff0000; font-weight: bold;"></rich:message>
						
						* Tipo de logradouro:
						<h:inputText id="txtTipoLogradouro" value="#{funcionarioMB.funcionario.endereco.tipoLogradouro }" maxlength="100"  />
						...
						* Número:
						<h:inputText id="txtNumero" value="#{funcionarioMB.funcionario.endereco.numero }"							
							maxlength="10">							
						</h:inputText>
						<rich:message for="txtNumero" style="color: #ff0000; font-weight: bold;"></rich:message>
						
						Complemento:
						<h:inputText value="#{funcionarioMB.funcionario.endereco.complemento }"  maxlength="50"></h:inputText>
						<h:inputHidden/>
						
						* Bairro:
						<h:inputText id="txtBairro" value="#{funcionarioMB.funcionario.endereco.bairro }"							
							maxlength="50"/>
						<rich:message for="txtBairro" style="color: #ff0000; font-weight: bold;"></rich:message>
						
						* Cidade:
						<h:inputText id="txtCidade" value="#{funcionarioMB.funcionario.endereco.cidade }"  />
						<rich:message for="txtCidade" style="color: #ff0000; font-weight: bold;"></rich:message>
						
						* UF:
						<h:inputText id="txtUF" value="#{funcionarioMB.funcionario.endereco.uf }" />
					...
					<h:panelGrid id="pnlTelefone" columns="7" cellspacing="10" style="padding: 10px 10px 10px 10px;">
						...
						DDD:	
						<h:inputText value="#{funcionarioMB.telefone.ddd }" size="5" 
						...
						Telefone:
						<h:inputText value="#{funcionarioMB.telefone.numero }" size="10" 
						...
						Tipo:
						<h:selectOneMenu value="#{funcionarioMB.telefone.tipoTelefone }" >
						...
						<a4j:commandButton value="Adicionar" style="padding: 3px 10px;" action="#{funcionarioMB.adicionarTelefone }" reRender="tableTelefones,pnlTelefone"  />
					</h:panelGrid>
			...
			<h:commandButton value="Cadastrar" style="padding: 3px 10px;"
				action="#{funcionarioMB.add }" rendered="#{funcionarioMB.canAdd }"></h:commandButton>
			&nbsp;&nbsp;
			<h:commandButton value="Cancelar" style="padding: 3px 10px;"
				immediate="true" action="#{funcionarioMB.cancelAction }"></h:commandButton>
